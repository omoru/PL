...
public class AnalizadorSintacticoTiny {
	...
	private void E0() {
		...
		default:  errores.errorSintactico(anticipo.fila(),anticipo.columna(),anticipo.clase(),
				...
				ClaseLexica.REAL, ClaseLexica.PAP,ClaseLexica.R_NOT,ClaseLexica.MENOS);                                    
		}  
	}
	private void RES0() {
		switch(anticipo.clase()) {
		...
		default:    
			errores.errorSintactico(anticipo.fila(),anticipo.columna(),anticipo.clase(),
					ClaseLexica.MAS,ClaseLexica.MENOS,ClaseLexica.SEMICOLON);                                              
		} 
	}
	private void E1() {
		switch(anticipo.clase()) {
	...
	private void RES2() {
		...
		default:    
			errores.errorSintactico(anticipo.fila(),anticipo.columna(),anticipo.clase(),
					...
					ClaseLexica.R_OR,ClaseLexica.MAS,ClaseLexica.MENOS,ClaseLexica.SEMICOLON);
		}  
	}
	private void E3() {
		switch(anticipo.clase()) {
		...
		default:    
			errores.errorSintactico(anticipo.fila(),anticipo.columna(),anticipo.clase(),
					ClaseLexica.ENT,ClaseLexica.IDEN,ClaseLexica.R_NOT,ClaseLexica.MENOS,ClaseLexica.PAP,ClaseLexica.REAL);
		}  
	}
	private void RES3() {
		switch(anticipo.clase()) {
		...
		default:    
			errores.errorSintactico(anticipo.fila(),anticipo.columna(),anticipo.clase(),
					...
					ClaseLexica.BNE,ClaseLexica.BLT,ClaseLexica.MAS,ClaseLexica.MENOS,ClaseLexica.SEMICOLON,ClaseLexica.R_OR);
		}  
	}
	private void E4() {
		switch(anticipo.clase()) {
		...
		default:    
			errores.errorSintactico(anticipo.fila(),anticipo.columna(),anticipo.clase(),
					ClaseLexica.MENOS,ClaseLexica.R_NOT,ClaseLexica.ENT,ClaseLexica.IDEN,ClaseLexica.PAP,ClaseLexica.REAL);
		}  
	}
	private void E5() {
		switch(anticipo.clase()) {
		...
		default:    
			errores.errorSintactico(anticipo.fila(),anticipo.columna(),anticipo.clase(),
					ClaseLexica.ENT,ClaseLexica.REAL,ClaseLexica.IDEN,ClaseLexica.PAP);
		}  
	}
