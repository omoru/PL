...
public class TinyASint {
    ...
    public static class Inst_if_then extends Inst{
    	...
    	public Exp exp() {return exp;}
    	public LInst_aux linst_aux() {return linst_aux;}
    	public void procesa(Procesamiento p) {
            p.procesa(this); 
         } 
    }
    public static class Inst_if_then_else extends Inst{
    	...
    	public Exp exp() {return exp;}
    	public LInst_aux linst_aux1() {return linst_aux1;}
    	public LInst_aux linst_aux2() {return linst_aux2;}
    	public void procesa(Procesamiento p) {
            p.procesa(this); 
         } 
    }
    ...
    public static class Inst_call_con_params extends Inst{
    	...
    	public StringLocalizado id() {return id;}
    	public LReal_params real_params() {return real_params;}
    	public void procesa(Procesamiento p) {
            p.procesa(this); 
         } 
    }
    ...
    public static class LReal_Params_muchos extends LReal_params{
    	...
    	public Exp exp() {return exp;}
    	public LReal_params params() {return params;}
    	public void procesa(Procesamiento p) {
            p.procesa(this); 
        } 
    }
