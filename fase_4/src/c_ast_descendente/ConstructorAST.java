...
public class ConstructorAST implements ConstructorASTConstants {
  ...
  final public Prog PROGRAMA() throws ParseException {
    ...
    case 59:
      linst = LINST();
                                         {if (true) return sem.programa(null,linst);}
      break;
    default:
      jj_la1[0] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Dec RES_DEC(StringLocalizado id_h) throws ParseException {
    ...
    case identificador:
      ...
      jj_consume_token(49);
      bloque = BLOQUE();
                                                                     {if (true) return sem.dec_proc_con_params(id_h,lparams,bloque);}
      break;
    case 49:
      jj_consume_token(49);
      bloque = BLOQUE();
                                                   {if (true) return sem.dec_proc_sin_params(id_h,bloque);}
      break;
    default:
      jj_la1[3] = jj_gen;
      jj_consume_token(-1);
  ...
  final public LParams RLPARAMS(LParams param_h) throws ParseException {
                                       Param param; LParams rlparams;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 50:
      jj_consume_token(50);
  ...
  final public Inst RES_CALL(StringLocalizado id_h) throws ParseException {
                                        LReal_params r_params;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 49:
      jj_consume_token(49);
                               {if (true) return sem.inst_call_sin_params(id_h);}
      break;
    case not:
    case r_true:
    case r_false:
    ...
    case 59:
      ...
      jj_consume_token(49);
                                                         {if (true) return sem.inst_call_con_params(id_h,r_params);}
      break;
    default:
      jj_la1[10] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Inst RES_IF(Exp exp_h, LInst_aux linst_aux_h) throws ParseException {
    ...
    case endif:
      jj_consume_token(endif);
                             {if (true) return sem.inst_if_then(exp_h,linst_aux_h);}
      break;
    default:
      jj_la1[12] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Exp E7() throws ParseException {
    ...
    case str:
      t = jj_consume_token(str);
                        {if (true) return sem.c_str(sem.str(t.image,t.beginLine,t.beginColumn));}
      break;
    case r_true:
      jj_consume_token(r_true);
                      {if (true) return sem.c_true();}
      break;
    case r_false:
      jj_consume_token(r_false);
                       {if (true) return sem.c_false();}
      break;
    case identificador:
      t = jj_consume_token(identificador);
                                 {if (true) return sem.identificador(sem.str(t.image,t.beginLine,t.beginColumn));}
      break;
    case r_null:
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0xf2201c00,0x0,0x1c00,0x1be000,0x0,0x0,0x1be000,0x0,0x0,0xf2200000,0x0,0xf2200000,0x1800000,0x0,0xf2201c00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0xc413c3f,0x8000,0x0,0x20400,0x40000,0x80400,0x400,0x8000,0x8000,0xc413c3f,0xc033c3c,0xc413c3f,0x0,0x40000,0xcc13c3f,0x6000000,0xc0,0xf0000000,0x8000000,0xc013c3c,0x100300,0x100300,0x8013c38,0x13c38,0xc0,0xf0000000,0x8000000,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0xc,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0xc,};
   }
